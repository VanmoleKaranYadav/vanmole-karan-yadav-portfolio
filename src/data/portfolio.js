  ...
  projects: [
    {
      ...
      badge: "Full-Stack",
      desc: "Full-stack healthcare portal for donor registration, organ request tracking, and hospital matching with secure role-based access.",
      technologies: ["React.js", "Node.js", "Express.js", "MongoDB", "REST APIs"],
      status: "Completed & Tested",
      highlights: [
        "Donor registration & identity verification",
        "Hospital patient request dashboard",
        "Encrypted authentication & database security",
      ],
      mockup: {
    ...
    },
    {
      ...
      badge: "AI / ML",
      desc: "AI agriculture platform delivering crop disease diagnosis, real-time market price trends, and localized weather insights.",
      technologies: ["Python", "Machine Learning", "FastAPI", "React.js", "APIs"],
      status: "Completed & Deployed",
      highlights: [
        "Predictive crop disease detection",
        "Regional crop market price forecasting",
        "Automated weather & irrigation alerts",
      ],
      mockup: {
